...
_TRIVIA = (
  _bounty("Which Soviet spacecraft was the first to make a soft landing on the Moon?", "Luna 9", "Luna 2", "Luna 10", "Zond 3"),
    ...
    _bounty("What is pogo oscillation in a launch vehicle?", "A longitudinal vibration caused by coupling between propulsion and vehicle structure", "A roll-control maneuver", "A nozzle cooling method", "A type of stage separation"),
