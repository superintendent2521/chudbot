    ...
    async def statistics_command(ctx: SlashContext):
        ...
        try:
            ...
            economy_lines = [
                ...
                f"Coins in accounts: {economy.total_balance:,}",
                f"Coins in market escrow: {economy.escrowed_coins:,}",
                f"Total coin supply: {economy.total_balance + economy.escrowed_coins:,}",
